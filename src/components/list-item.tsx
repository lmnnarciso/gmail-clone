    ...
    >
      ...
      <div className="flex min-w-0 flex-1">
        <div className="line-clamp-1 max-w-full flex-shrink-0 overflow-hidden text-ellipsis text-sm font-bold text-white">
          {props.content}1212 aaaaaaaaaaaa sssssssssssss
        </div>
        ...
        <div className=" line-clamp-1 max-w-full overflow-hidden text-ellipsis text-sm text-white/50">
          ...
          minima eaque officia harum iure assumenda dolorum fugit optio tempora
          labore quam non sequi? Libero eligendi magnam modi numquam iure.
        </div>
      </div>

      <div className="date ml-auto hidden text-xs font-bold">
